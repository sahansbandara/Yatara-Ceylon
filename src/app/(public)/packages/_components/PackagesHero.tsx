...
export default function PackagesHero({ packageCount }: PackagesHeroProps) {
        ...
        <section ref={heroRef} className="relative h-screen min-h-[700px] max-h-[1200px] overflow-hidden">
            ...
            <motion.div style={{ y: heroY }} className="absolute inset-0 -top-[10%] h-[120%]">
                <Image
                    ...
                    alt="Sri Lanka Curated Luxury Journeys"
                    fill
            ...
            >
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        Handcrafted Sri Lankan Experiences
                    </motion.p>
                    ...
                    >
                        Curated <span className="text-antique-gold font-serif italic drop-shadow-[0_4px_24px_rgba(0,0,0,0.6)] font-semibold">Journeys</span>
                    </motion.h1>
                    ...
                    >
                        <div className="text-center">
                            <p className="text-2xl sm:text-3xl font-display text-white mb-1">{packageCount}</p>
                            <p className="text-[10px] tracking-[0.25em] uppercase text-white/50">Curated Routes</p>
                        </div>
