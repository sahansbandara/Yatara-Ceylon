...
export default function DestinationCard({ destination, variant = 'default', index }: DestinationCardProps) {
    ...
    return (
        <Link
            ...
            className="group block relative overflow-hidden rounded-2xl h-full destination-card-shine ring-1 ring-white/[0.05] hover:ring-[#D4AF37]/50 transition-all duration-800 ease-out"
            style={{
        ...
        >
            <div className={`relative w-full h-full ${minHeightClass} overflow-hidden`}>
                ...
                <Image
                    ...
                    fill
                    className="object-cover transform group-hover:scale-[1.08] group-hover:rotate-[0.5deg] transition-all duration-1500 ease-liquid"
                ...
                <div className="absolute bottom-0 inset-x-0 z-10 p-6 sm:p-8 flex flex-col justify-end transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-liquid">
                    {/* Luxury micro-label */}
                    ...
                    {destination.description && (
                        <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-liquid">
